# Roles And Permissions For Laravel 5.3 through 5.5

### This is a direct clone of https://github.com/romanbican/roles with the 5.3, 5.4 and 5.5 fixes added
...
'providers' => [
     ...
     */
    NigelHeap\Roles\RolesServiceProvider::class,
...
```php
use NigelHeap\Roles\Traits\HasRoleAndPermission;
use NigelHeap\Roles\Contracts\HasRoleAndPermission as HasRoleAndPermissionContract;
...
```php
use NigelHeap\Roles\Models\Role;
...
```php
use NigelHeap\Roles\Models\Permission;
...
protected $routeMiddleware = [
    ...
    'role' => \NigelHeap\Roles\Middleware\VerifyRole::class,
    'permission' => \NigelHeap\Roles\Middleware\VerifyPermission::class,
    'level' => \NigelHeap\Roles\Middleware\VerifyLevel::class,
];
```
...
{
    if ($e instanceof \NigelHeap\Roles\Exceptions\RoleDeniedException) {
...
For more information, please have a look at [HasRoleAndPermission](https://github.com/romanNigelHeap/roles/blob/master/src/NigelHeap/Roles/Contracts/HasRoleAndPermission.php) contract.
